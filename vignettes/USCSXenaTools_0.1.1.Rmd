---
title: "UCSCXenaTools: Download Public Data from UCSC Xena Hubs"
...
output:
  ...
  pdf_document:
    toc: true
vignette: >
  %\VignetteIndexEntry{download publical data in batch mode}
...
**For now, you can use this package to batch download data from UCSC Xena. I am developing more easier and consistent way to query, download, and prepare datasets.**
