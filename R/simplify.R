    ...
    if("TCGA" %in% Target){
        ...
        ob %>%
            mutate(DataType = case_when(
                ...
                grepl("Agilent", XenaDatasets) ~ "Gene Expression Array",
                ...
                grepl("HiSeq$", XenaDatasets) ~ "Gene Expression RNAseq",
        ...
        ob %>%
            mutate(FileType = case_when(
                ...
                DataType == "Exon Expression RNAseq" & grepl("GA_exon", XenaDatasets) ~ NA,
                DataType == "Exon Expression RNAseq" & grepl("GAV2_exon", XenaDatasets) ~ NA,
                DataType == "Exon Expression RNAseq" & grepl("HiSeq_exon", XenaDatasets) ~ NA,
                DataType == "Exon Expression RNAseq" & grepl("HiSeqV2_exon", XenaDatasets) ~ NA,


                DataType == "Gene Expression Array" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Gene Expression Array" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Gene Expression Array" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Gene Expression Array" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Gene Expression Array" & grepl("iCluster", XenaDatasets) ~ NA,
                ...
                DataType == "Gene Expression RNAseq" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Gene Expression RNAseq" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Gene Expression RNAseq" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Gene Expression RNAseq" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Gene Expression RNAseq" & grepl("iCluster", XenaDatasets) ~ NA,
                ...
                DataType == "miRNA Mature Strand Expression RNAseq" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "miRNA Mature Strand Expression RNAseq" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "miRNA Mature Strand Expression RNAseq" & grepl("iCluster", XenaDatasets) ~ NA,


                DataType == "PARADIGM Pathway Activity" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "PARADIGM Pathway Activity" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "PARADIGM Pathway Activity" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "PARADIGM Pathway Activity" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "PARADIGM Pathway Activity" & grepl("iCluster", XenaDatasets) ~ NA,
                ...
                DataType == "Phenotype" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Phenotype" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Phenotype" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Phenotype" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Phenotype" & grepl("iCluster", XenaDatasets) ~ NA,
                ...
                DataType == "Protein Expression RPPA" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Protein Expression RPPA" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Protein Expression RPPA" & grepl("iCluster", XenaDatasets) ~ NA,


                DataType == "Somatic Mutation" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Somatic Mutation" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Somatic Mutation" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Somatic Mutation" & grepl("iCluster", XenaDatasets) ~ NA,
                DataType == "Somatic Mutation" & grepl("iCluster", XenaDatasets) ~ NA,
...
# > dput(ob2)
# structure(list(XenaDatasets = c("ACC_clinicalMatrix", "AgilentG4502A_07_1",
